  ...
  $(function() {
    return window.Background = {
      ...
      tick: function(option) {
        var ani_style, c, constructor, doc_hei, excep, exception, op, p, r_http, r_http_img, win_hei, _i, _len, _ref;
        p = this.internal;
        constructor = {
          data: "",
          horizontal: "center",
        ...
        for (_i = 0, _len = exception.length; _i < _len; _i++) {
          excep = exception[_i];
          if (p.$b.hasClass(excep)) {
            return true;
          }
        }
        if (arguments.length) {
        ...
        c = function(value) {
          var day, end, moment, now, start, this_moment, _j, _len1, _ref, _ref1;
